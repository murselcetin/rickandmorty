...
class SeasonFilterPagingSource(val apiService: RetroService, val season: SeasonAction): PagingSource<Int, EpisodeData>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, EpisodeData> {
        return try {
            ...
            val response = apiService.getSeasonEpisode(nextPage, season.season)
