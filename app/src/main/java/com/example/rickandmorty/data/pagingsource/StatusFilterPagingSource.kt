...
class StatusFilterPagingSource(val apiService: RetroService, val status: StatusAction): PagingSource<Int, CharacterData>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CharacterData> {
        return try {
            ...
            val response = apiService.getStatusCharacter(nextPage,status.status)
